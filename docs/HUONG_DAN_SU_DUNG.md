...
**🌐 Links Web app:** [https://cbs-recruitment-web.vercel.app/](https://cbs-recruitment-web.vercel.app/)

Trước khi đi vào chi tiết, bạn cần hiểu cách một ứng viên xuất hiện trong hệ thống. Có **3 luồng chính**:

### 2.1. Luồng HO (Head Office - Văn Phòng Chính)

1.  **Luồng Tự Động (Auto from Email)**:
    - Hệ thống tự động quét Email tuyển dụng từ CareerViet.
    - Khi có ứng viên gửi CV qua Email, hệ thống tự động bóc tách thông tin và đưa thẳng vào **HO Datapool**.
...
- 📁 [Drive Tổng HO](https://drive.google.com/drive/u/1/folders/1P60dhESnbsmEOEqBP_hl6f_xWn1cgl_8)
- 📊 [HO Datapool](https://docs.google.com/spreadsheets/d/191CzArhWOeyCeRPHlhSbibMG-q_qfW3k2YUCPLvG06w/edit?gid=0#gid=0)

**HO Email login Web: cbsvn.officetalenthub@gmail.com**

### 2.2. Luồng Store (Cửa Hàng)

1.  **Google Forms (Tự động)**:
    - Có 3 biểu mẫu tuyển dụng Store (Mr. Vũ, Ms. Cam, Ms. Phương Anh)
    - Khi ứng viên điền form, dữ liệu tự động đổ vào **Store Datapool** qua Google Apps Script
    - _Không cần Recruiter nhập tay_
2.  **Upload thủ công qua Drive**:
    - Recruiter Store upload CV vào Store Drive Folder
    - Hệ thống N8N tự động xử lý và đổ vào Store Datapool

**Links Store:**

- 📁 [Drive Tổng Store](https://drive.google.com/drive/u/1/folders/1fDDZvVLCEWanjH4J96t2ek5XpOQ3Prgo)
- 📊 [Store Datapool](https://docs.google.com/spreadsheets/d/1GvIdlI4VTa0h4UeRjh6YjKV_SmhOU8OSbwSGGlvGTRs/edit?gid=0#gid=0)
- 📝 [Biểu mẫu 1 - Mr. Vũ](https://docs.google.com/forms/d/1Zrt6oZQVbe7rzmMqcK9Mbc5u7SLZ2CkAtqMqwWEg8vY/edit)
- 📝 [Biểu mẫu 2 - Ms. Cam](https://docs.google.com/forms/d/1DVPGpg00iygr8QZVzv0JMwt77-u31QpJ9yrRArwZ8Pw/edit)
- 📝 [Biểu mẫu 3 - Ms. Phương Anh](https://docs.google.com/forms/d/1mmj9YQF9KxKqT3w7F5NUdu5uBdJKelBH-18OwskZWGM/edit)

**ST Email login Web: cbsvn.storetalenthub@gmail.com**

### Sơ Đồ Luồng Xử Lý (Đầy Đủ)

![Sơ đồ luồng xử lý](../assets/web-process.png)
...
└─────────────────────────────────────────────────────────────────────────────┘
         │                           │                          │
    (1) Email HO          (2) Tab Input (HO/Store)    (3) Google Forms (Store)
         │                           │                          │
         └───────────────┬───────────┴──────────────────────────┘
                         ↓
┌─────────────────────────────────────────────────────────────────────────────┐
...
│                                                                             │
│  ┌─────────────────────┐              ┌─────────────────────┐              │
│  │   HO DATAPOOL       │              │  STORE DATAPOOL     │              │
│  │  • Email tự động    │              │  • Google Forms     │              │
│  │  • Upload thủ công  │              │  • Upload Drive     │              │
│  └─────────────────────┘              └─────────────────────┘              │
│                                                                             │
│  Tính năng chung:                                                           │
│  • AI tự động chấm điểm (Match Score)                                       │
│  • Tóm tắt hồ sơ (AI Summary)                                               │
│  • Lọc theo Score, Nguồn, Thời gian, Data Source (HO/Store)                │
...
│  • Filter theo Job Code, Score, Date Range, Data Source                     │
│  • View Toggles: Active / Rejected / Stock                                  │
│  • Badge màu: HO (Xanh) / Store (Tím)                                       │
└─────────────────────────────────────────────────────────────────────────────┘
                                  │
                                  │ (Nếu Job bị Stop)
                                  ↓
...
│  • Thống kê theo Job Code, Source, Status, Data Source (HO/Store)           │
│  • Số lượng: Active / Hired / Rejected / Stock                              │
│  • Hiệu quả nguồn tuyển dụng (LinkedIn, TopCV, Email, Forms...)             │
└─────────────────────────────────────────────────────────────────────────────┘
```
